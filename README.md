...
## 🚀 What I Work On
- **Quantum & Physics Projects** → modeling, computation, and simulation  
- **Data Science & AI** → machine learning experiments, automation, and applied problem-solving  
- **Engineering Tools** → practical systems to streamline workflows (technical submittals, automation, etc.)  
- **Web Development** → starting with HTML/CSS/JS to showcase my work online  

---

## 📂 Featured Repos
- [My Personal Portfolio](https://github.com/lukedev45/Portfolio)  
- [Semantic Book Recomender](https://github.com/lukedev45/book-recommender)
